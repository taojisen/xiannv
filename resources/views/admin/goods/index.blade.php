            ...
            aria-describedby="DataTables_Table_1_info">
                <thead>
                    <tr role="row">
                        ...
                        rowspan="1" colspan="1" class=".txt" style="width: 30px;" aria-label="Browser: activate to sort column ascending">
                            品牌
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                        ...
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
                        rowspan="1" colspan="1" class=".txt" aria-label="Platform(s): activate to sort column ascending">
                            商品描述
                        </th>
                        <th class="sorting" role="columnheader" tabindex="0" aria-controls="DataTables_Table_1"
